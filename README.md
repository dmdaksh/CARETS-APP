...
We can also look at the following tree structure to better understand the data structure. The search term for the following tree is `Glioma` and total number of records fetched from the SEERS API is 1000.
